  ...
  createApp({
    ...
    methods:{
        ...
        login() {
            ...
            // Bandera para indicar si se encontró una coincidencia
            let found = false;
        ...
        recuperarContraseña(){
            ...
            if (found) {
                ...
                let modalRecuperar = new bootstrap.Modal(document.getElementById('recuperarModal'));

                // Cerrar el modal actual
                modalRecuperar.hide();
                // Abrir el nuevo modal usando funciones de Bootstrap 5
